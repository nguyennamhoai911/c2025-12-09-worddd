...
;
const API_URL = ("TURBOPACK compile-time value", "https://vocab-backend-aveq.onrender.com") || 'https://localhost:5000';
...
function AuthProvider({ children }) {
    ...
    const login = async (email, password)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/login', {
            email,
            password
        });
    ...
    const register = async (email, password, name)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/register', {
            email,
            password,
            name
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f8755c5a._.js.map